  ...
  List<dynamic> _filteredStudents() {
    ...
    students.sort((a, b) {
      switch (_sortBy) {
        ...
        case 'status':
          return (a['form_status'] ?? '').toString().compareTo(
                (b['form_status'] ?? '').toString(),
              );
        case 'reg':
          return (a['register_number'] ?? '').toString().compareTo(
                (b['register_number'] ?? '').toString(),
              );
        default:
...
class _StudentsTab extends StatelessWidget {
  ...
  PopupMenuItem<String> _menuItem(
    ...
    return PopupMenuItem(
      ...
      child: Row(
        children: [
          Icon(icon, size: 18, color: selected ? hodColor : Colors.grey),
              ...
              CircleAvatar(
                ...
                child: Text(
                  (student['student_name'] ?? 'S')
                      ...
                      .toUpperCase(),
                  style: TextStyle(
                    color: _hasSubmitted ? hodColor : Colors.grey,
                    fontWeight: FontWeight.w700,
                    fontSize: 16,
                  ),
                ),
                ...
                children: [
                  ...
                  if (student['star_rating'] != null)
                    Padding(
                      ...
                      child: StarRating(
                        stars: student['star_rating'] as int,
                        size: 12,
                      ),
                    ),
                ],
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: const [
                            DropdownMenuItem(
                              value: 'average',
                              child: Text('Average (5 pts)'),
                            ),
                            DropdownMenuItem(
                              value: 'good',
                              child: Text('Good (10 pts)'),
                            ),
                            DropdownMenuItem(
                              value: 'excellent',
...
class _SSMHodReportScreenState extends State<SSMHodReportScreen> {
  ...
  Future<void> _exportCsv() async {
    ...
    try {
      ...
      final file = File('${dir.path}/dept_report_2025-26.csv');
